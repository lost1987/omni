...
CREATE TABLE `gms_core_admin` (
  ...
  `selected_server_id` int(11) NOT NULL DEFAULT '1' COMMENT '最后一次选择的server的id',
  `pid` int(11) NOT NULL DEFAULT '0' COMMENT '父账号ID',
  PRIMARY KEY (`id`),
  UNIQUE KEY `account` (`account`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='gms用户表';

-- ----------------------------
--  Records of `gms_core_admin`
-- ----------------------------
BEGIN;
INSERT INTO `gms_core_admin` VALUES ('1', 'admin', '52f6e9b0d8bdc8c1053af659937f6006', '管理员', '-1', '1', '10001', '0'), ('17', 'buhuan', '092c84d9c11b7239ebf6c1cf7547f901', '卜峘', '0', '0', '10001', '1'), ('18', 'children', 'e05ea8eb195cbf2179b8f2f9f1fe5b45', 'buhuan子账号1', '0', '0', '10001', '17');
COMMIT;
...
CREATE TABLE `gms_core_admin_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='gms模块权限表';

-- ----------------------------
--  Records of `gms_core_admin_module`
-- ----------------------------
BEGIN;
INSERT INTO `gms_core_admin_module` VALUES ('1', '1', '2', '3'), ('2', '1', '7', '1'), ('88', '17', '1', '0'), ('89', '17', '10', '1'), ('90', '17', '17', '0'), ('91', '17', '2', '7'), ('92', '17', '19', '0'), ('93', '17', '28', '7'), ('94', '17', '5', '0'), ('95', '17', '22', '31'), ('96', '17', '7', '0'), ('97', '18', '10', '0'), ('98', '18', '2', '1'), ('99', '18', '28', '0'), ('100', '18', '22', '0');
COMMIT;
...
CREATE TABLE `gms_core_module` (
  ...
  `module_alias` varchar(32) NOT NULL COMMENT '模块别名,通常为英文和php模块字典类对应',
