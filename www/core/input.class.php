<?php
    ...
    class Input {
        ...
        private $_source_post = null;

        private $_source_get = null;
        /**
        ...
        public function __construct()
        {
            ...
            $this->_source_get = $_GET;
            $this->_source_post = $_POST;
         ...
         * @return mixed
         */
        function sPost($index){
            return $this->_source_post[$index];
        }
